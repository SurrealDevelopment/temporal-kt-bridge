 ...
 * }
 */
public class TemporalCoreRuntimeOrFail {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        temporal_sdk_core_c_bridge_h.C_POINTER.withName("runtime"),
        temporal_sdk_core_c_bridge_h.C_POINTER.withName("fail")
    ).withName("TemporalCoreRuntimeOrFail");
    ...
    private static final long runtime$OFFSET = $LAYOUT.byteOffset(groupElement("runtime"));
